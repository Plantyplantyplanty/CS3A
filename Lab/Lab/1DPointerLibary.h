#pragma once
//This does NOT like having an ifndef added to it. I suspect it's something to do with 
//templated classes and I should look that up once I'm done commenting. 
...
template <typename T>
void intialize1D(T* row, int size, T value);
